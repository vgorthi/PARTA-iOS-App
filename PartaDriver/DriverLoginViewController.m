...
- (IBAction)loginPressed:(id)sender {
    [self loginUserToServer];
}

-(void)loginUserToServer;
{
        [self performSegueWithIdentifier:@"goToMapScreenFromLogin" sender:nil];
...
//    
//    GIFProgressHUD *hud = [GIFProgressHUD showHUDWithGIFName:@"newsquares" title:@"Please wait..." detailTitle:@"Logging in..." addedToView:self.view animated:YES];
...
//            [userService loginUser:userDict withCompletion:^(NSError *error, id results) {
//                
//                [self performSegueWithIdentifier:@"goToMapScreenFromLogin" sender:nil];
//                
